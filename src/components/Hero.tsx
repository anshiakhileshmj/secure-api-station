...
import '@/contexts/main.css';

// Extend window type so TypeScript knows about WebFont
declare global {
  interface Window {
    WebFont?: any;
    DocumentTouch?: any;
    ...
    <div className="page-wrapper">
      ...
      <div className="header">
        <div className="header-logo">
          <img src="/aml_logo.png" loading="lazy" alt="AML Logo" className="image-contain" />
        </div>
      </div>
