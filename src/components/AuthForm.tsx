...
import { Shield, Mail, Lock, AlertCircle, Users, CheckCircle, Eye, EyeOff, User } from 'lucide-react';
...
const AuthForm = () => {
  ...
  const features = [
    {
      ...
      description: "Integrate with Supabase's sophisticated APIs or openly to choose a built-ready or low-code solution."
    },
    {
      icon: CheckCircle,
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Panel - Features */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-background via-card to-muted/30 p-12 flex-col justify-center">
